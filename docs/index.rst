...
This is documentation and guidance for using *sdcMicro* from command-line. *sdcMicro* 
is an *R* package, which provides tools for Statistical Disclosure Control (SDC) for microdata, 
...
**Preferred citation of this guide:** Benschop, T. and Welch, M. (n.d.) Statistical Disclosure Control for Microdata: A Practice Guide. Retrieved (insert date), from  https://sdcpractice.readthedocs.io/en/latest/ License: Creative Commons Attribution CC-BY 4.0.
